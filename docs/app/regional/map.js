...
const SOURCE_META = {
  ...
  'Tamil News':           { lang:'Tamil',     region:'Tamil Nadu',    color:'#fde68a', dot:'#fbbf24', bg:'rgba(251,191,36,0.15)'   },
  ...
  'Telugu News':          { lang:'Telugu',    region:'Andhra/Telangana', color:'#ddd6fe', dot:'#a78bfa', bg:'rgba(167,139,250,0.15)' },
  ...
  'Maharashtra Times':    { lang:'Marathi',   region:'Maharashtra',   color:'#d9f99d', dot:'#a3e635', bg:'rgba(163,230,53,0.15)'   },
  'Sakal':                { lang:'Marathi',   region:'Maharashtra',   color:'#d9f99d', dot:'#a3e635', bg:'rgba(163,230,53,0.15)'   },
  'Marathi News':         { lang:'Marathi',   region:'Maharashtra',   color:'#d9f99d', dot:'#a3e635', bg:'rgba(163,230,53,0.15)'   },
  'Lokmat':               { lang:'Marathi',   region:'Maharashtra',   color:'#d9f99d', dot:'#a3e635', bg:'rgba(163,230,53,0.15)'   },
  'Divya Bhaskar':        { lang:'Gujarati',  region:'Gujarat',       color:'#fef08a', dot:'#eab308', bg:'rgba(234,179,8,0.15)'    },
  'Gujarat Samachar':     { lang:'Gujarati',  region:'Gujarat',       color:'#fef08a', dot:'#eab308', bg:'rgba(234,179,8,0.15)'    },
  'Gujarati News':        { lang:'Gujarati',  region:'Gujarat',       color:'#fef08a', dot:'#eab308', bg:'rgba(234,179,8,0.15)'    },
...
const LANG_COLORS = {
  ...
  Gujarati:  { color:'#fef08a', dot:'#eab308', bg:'rgba(234,179,8,0.15)'    },
  Odia:      { color:'#fed7aa', dot:'#f97316', bg:'rgba(249,115,22,0.12)'   },
  Assamese:  { color:'#c4b5fd', dot:'#8b5cf6', bg:'rgba(139,92,246,0.12)'   },
